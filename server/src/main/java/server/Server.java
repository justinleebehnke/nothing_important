...
import services.clear.ClearHandler;
import services.event.EventHandler;
import services.fill.FillHandler;
import services.load.LoadHandler;
import services.login.LoginHandler;
import services.person.PersonHandler;
import services.register.RegisterHandler;
...
public class Server {
    ...
    private void run(String portNumber) {
        System.out.print("Listening on port number " + portNumber + "\n");
        ...
        // Log services.message indicating that the server is creating and installing
        // its HTTP handlers.
        ...
        server.createContext("/index.html", new DefaultFileHandler());
        server.createContext("/", new DefaultFileHandler());

        // Log services.message indicating that the HttpServer is about the start accepting
